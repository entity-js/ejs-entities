 ...
 * @async
 */
Entities.prototype.initialize = function (done) {
  'use strict';
 ...
 * @return {Entities} Returns self.
 * @chainable
 */
Entities.prototype.registerPlugin = function (name, title, description, cb) {
  'use strict';
 ...
 */
Entities.prototype.registeredPlugin = function (name) {
  'use strict';

  return _plugins[name] !== undefined;
};
 ...
 * @chainable
 */
Entities.prototype.unregisterPlugin = function (name) {
  'use strict';
 ...
 */
Entities.prototype.plugin = function (name) {
  'use strict';
 ...
 *
 * @method plugins
 * @return {Object} An object containing all the details of the defined plugins.
 */
Entities.prototype.plugins = function () {
  'use strict';
